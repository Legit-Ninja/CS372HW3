...
public class CityMenu extends JFrame implements MouseMotionListener {
    ...
    /**
     * initializes the JFrame and panels
    ...
    public CityMenu() {
        ...
        kidSumbitButton.addActionListener(new ActionListener() {          //makes a new kid based on entered text
            /**
             * listens for kidSubmit and makes/adds a new kid object
             * @author Ben Greenwood
             * @version 1.0 1/13/2019
             */
            @Override
        ...
        TeacherSubmitButton.addActionListener(new ActionListener() {                  //makes a new teacher based on entered text
            /**
             Listens for the teacherSubmitbutton, makes and adds a new teacher
             @author Ben Greenwood
             @version 1.0 1/13/2019
             */
            @Override
        ...
        policemanSubmitButton.addActionListener(new ActionListener() {                   //makes a new policeman based on entered text
            /**
             * listens for policesubmit and makes/adds a new police object with specified parameters in the text fields
             * @author Ben Greenwood
             *              @version 1.0 1/13/2019
             */
            @Override
        ...
        getPopulationButton.addActionListener(new ActionListener() {                //displays everyone's info
            /**
             * listens for getpopulation button and opens the info in a new JFrame
             * @author Ben Greenwood
             *              @version 1.0 1/13/2019
             */
            @Override
        ...
        schoolButton.addActionListener(new ActionListener() {                              //displays teachers and kid informaaiton
            /**
             * listens for school button and opns a new JFrame with the school info
             * @author Ben Greenwood
             *              @version 1.0 1/13/2019
             */
            @Override
        ...
        cityHallButton.addActionListener(new ActionListener() {                                 //displays police information
            /**
             * listens for the cityhallinfo buttons and opens a new JRame with the info of people in cityhall
             * @author Ben Greenwood
             *              @version 1.0 1/13/2019
             */
            @Override
    ...
    /**
     * uses the mousemotionlistener interface and implements it for this projects to listen for draggin labels in mapPanel
     * @author Ben Greenwood
     *              @version 1.0 1/13/2019
     */
